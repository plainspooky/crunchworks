...
INCLUDE		./library/msxdos1bdos.asm
...
BINSTART:
BINEXEC:	jr ENABLINK					; Enable BLINKING cursor
			
			jr DISBLINK					; Disable BLINKING cursor
...
; Apple II's ?
; RAINBOW:	db 0xc0, 0xa0, 0x90, 0x80, 0xd0, 0x40, 0x70, 0x30
